...
import svgPaths from "./svg-4nfwxvizku";
import imgApp from "figma:asset/9c730196e9eeb1f72fa56232fdc3c8eb2dcd2428.png";
...
import imgContainer2 from "figma:asset/2d31031bf66a52f6b4227de4cacfcc640b147883.png";
import imgContainer3 from "figma:asset/2e1e50656e46b4f478e6c20270297a0df4471478.png";
import imgContainer4 from "figma:asset/492cfe147a6d419c26f2458be3d723a356423e9c.png";
import imgContainer5 from "figma:asset/350b03cd9be970d67a928d470d8f344a995bc729.png";
import imgContainer6 from "figma:asset/4d82157e1d7e2352cf54ca9ae0151bc85a6a338a.png";
import imgApp1 from "figma:asset/5b450a7110e000ba2f5c2131ad2b26158a225c8a.png";
import imgApp2 from "figma:asset/f585ed3bbbfe2de88dbd5011fa308c25ae9182b6.png";
...
function AppBackgroundImage() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.4)] content-stretch flex items-center justify-center left-[31px] p-[20px] rounded-[16.4px] top-[534px] w-[221px]">
      ...
      <div className="relative shrink-0 size-[25.801px]">
...
function ContainerBackgroundImageAndText({ text }: ContainerBackgroundImageAndTextProps) {
  return (
    <BackgroundImage3 additionalClassNames="justify-center py-[5px]">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[14px] text-white tracking-[-0.1504px] whitespace-nowrap">{text}</p>
    </BackgroundImage3>
  );
}

function NavigationBackgroundImage() {
  return (
    <BackgroundImage3 additionalClassNames="gap-[24px] h-full py-px">
...
function ButtonBackgroundImageAndText({ text }: ButtonBackgroundImageAndTextProps) {
  return (
    <div className="relative shrink-0 w-[70px]">
      <BackgroundImageAndText text={text} additionalClassNames="w-full" />
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[100px] shrink-0 w-[88px]">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start relative w-full">
        <div style={{ backgroundImage: "linear-gradient(90deg, rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.1) 100%), linear-gradient(90deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.2) 100%)" }} className="content-stretch flex h-[35.5px] items-center justify-center relative rounded-[20px] shrink-0 w-full">
...
function ContainerBackgroundImage10() {
  return (
...
function ContainerBackgroundImage9() {
  return (
    <div className="bg-[rgba(0,0,0,0.2)] content-stretch flex h-[48px] items-center justify-center p-px relative rounded-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="relative shrink-0 size-[24px]">
...
function ContainerBackgroundImage8() {
  return (
    <div className="-translate-x-1/2 absolute bg-[rgba(0,0,0,0.2)] content-stretch flex gap-[15.832px] h-[137.46px] items-center justify-center left-1/2 px-[21px] py-px rounded-[18.999px] top-[820.77px]">
      ...
      <div className="h-[105px] pointer-events-none relative rounded-[10.555px] shrink-0 w-[120px]">
      ...
      <div className="h-[105px] relative rounded-[10.555px] shrink-0 w-[120px]">
        <img alt="" className="absolute bg-clip-padding border-0 border-[transparent] border-solid inset-0 max-w-none object-cover pointer-events-none rounded-[10.555px] size-full" src={imgApp} />
      </div>
      <div className="h-[105px] relative rounded-[10.555px] shrink-0 w-[120px]">
...
function ContainerBackgroundImage6() {
  return (
    <div className="bg-[rgba(0,0,0,0.2)] content-stretch flex h-[48px] items-center justify-center p-px relative rounded-[16px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[16px]" />
      <div className="relative shrink-0 size-[24px]">
...
export default function Frame() {
  return (
    <div className="content-stretch flex gap-[290px] items-center relative size-full">
      <div className="h-[1043px] relative shrink-0 w-[1527px]" data-name="App">
        ...
        <div className="absolute content-stretch flex gap-[24px] items-center left-[586px] top-[56.5px]">
          <BackgroundImage3 additionalClassNames="gap-[24px] h-[44px] py-px">
            <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.4)] border-solid inset-0 pointer-events-none rounded-[16777200px]" />
            <BackgroundImage />
            <ButtonBackgroundImageAndText text="My Playlist" />
        ...
        <div className="absolute content-stretch flex gap-[21px] items-center left-[34px] top-[106px]" data-name="Container">
          <BackgroundImage3 additionalClassNames="gap-[8px] py-[5px]">
            <div aria-hidden="true" className="absolute border border-[rgba(255,255,255,0.2)] border-solid inset-0 pointer-events-none rounded-[16777200px]" />
          ...
          <ContainerBackgroundImageAndText text="Sunset Mood" />
        </div>
        <AppBackgroundImage />
      </div>
      <div className="h-[1043px] relative shrink-0 w-[1527px]" data-name="App">
      ...
      <div className="h-[1043px] relative shrink-0 w-[1527px]" data-name="App">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgApp1} />
        <div className="absolute content-stretch flex flex-col items-start left-[414px] size-[48px] top-[271px]" data-name="InteractionIcon">
          <ContainerBackgroundImage />
        </div>
        <div className="absolute content-stretch flex flex-col items-start left-[616px] size-[48px] top-[377px]" data-name="InteractionIcon">
      ...
      <div className="h-[1043px] relative shrink-0 w-[1527px]" data-name="App">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgApp2} />
        <div className="absolute content-stretch flex flex-col items-start left-[414px] size-[48px] top-[271px]" data-name="InteractionIcon">
          <ContainerBackgroundImage />
        </div>
        <div className="absolute content-stretch flex flex-col items-start left-[616px] size-[48px] top-[377px]" data-name="InteractionIcon">
